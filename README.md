...
<table width="100%">
    <tr>
        <td colspan="2" align="center">
            <h2>My name is Manish Pushkar</h2>
            <p><strong>CMS Architect | Headless CMS Specialist | WordPress Enterprise Developer</strong></p>
            <p>13<sup>+</sup> years of experience designing scalable, API-driven web platforms using WordPress, Contentful, Drupal, and custom PHP systems.</p>
    ...
    <tr>
        ...
        <td valign="top" width="50%">
            ...
            <ul>
                ...
                <li>Enterprise-grade web platforms</li>
            </ul>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="2">
            ...
            <p><strong>Tech/Tools:</strong> CSS3, Bootstrap 4, WordPress, ACF Pro, PHP, Ajax, REST API, Git, Jira, Confluence</p>
            <hr/>
            ...
            <p><strong>Tech/Tools:</strong> HTML5, CSS3, Bootstrap 4/5, WordPress, ACF Pro, PHP, Ajax, Git, Jira, Confluence, Adobe XD, AEM</p>
            <hr/>
            ...
            <p><strong>Tech/Tools:</strong> HTML5, CSS3, Bootstrap 4, WordPress, Drupal, Contentful, PHP, Ajax, Figma, Adobe XD</p>
            <hr/>
            ...
            <ul>
                ...
                <li>Developed landing pages, websites, and emailers for brands like GE Healthcare and Cognizant</li>
            </ul>
            <p><strong>Tech/Tools:</strong> HTML5, CSS3, Bootstrap 3/4, WordPress, Contentful, PHP, Ajax, Photoshop, Adobe XD</p>
            <hr/>
            ...
            <p><strong>Tech/Tools:</strong> HTML5, CSS3, Bootstrap 4, WordPress, Magento, PHP, Ajax, REST API, Photoshop</p>
            <hr/>
            ...
            <p><strong>Tech/Tools:</strong> HTML5, CSS3, Bootstrap 4, WordPress, PHP, Ajax</p>
            <hr/>
            ...
            <ul>
                ...
                <li>Gained strong foundation in full-stack web development</li>
            </ul>
            <p><strong>Tech/Tools:</strong> HTML5, CSS3, Bootstrap 3, WordPress, PHP</p>
            <hr/>
            ...
            <p><strong>Tech/Tools:</strong> HTML, CSS, JavaScript</p>
        </td>
    </tr>
    <tr>
        <td colspan="2" align="center">
...
<!--
**imanishpushkar/imanishpushkar** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
